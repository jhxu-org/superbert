...
def path2rest(path, iid2captions, iid2split):
    ...
    return [path.replace('/search/gpu3/xujianhua/data','/search/gpu3/xujianhua/data/dino_patch'), captions, name, split]
...
if __name__ == "__main__":
    make_arrow('/search/gpu3/xujianhua/data/flickr30k', '/search/gpu3/superbert')