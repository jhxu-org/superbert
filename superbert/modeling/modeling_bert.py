...
from transformers.models.bert.modeling_bert import (BertEmbeddings, 
        ...
        BertSelfOutput, BertIntermediate, BertOutput,load_tf_weights_in_bert,
        BertPooler, BertPreTrainedModel,BERT_PRETRAINED_MODEL_ARCHIVE_LIST,
...
class FeatEmbed(nn.Module):
    """ Image to Patch Embedding
    """
    def __init__(self, feat_dim=512, embed_dim=768):
        super().__init__()
        # self.embeddings = nn.Embedding(feat_dim, feat_hidden, padding_idx=0)
