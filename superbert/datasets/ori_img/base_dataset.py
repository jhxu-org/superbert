...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def get_raw_image(self, index, image_key="image"):
        ...
        # image_bytes.seek(0)
        return Image.open(self.table[image_key][index].as_py()).convert("RGB")
    ...
    def get_image(self, index, image_key="image"):
        ...
        false_image_tensor = [self.transforms(image)]
        choices_img = [false_image_tensor, image_tensor]
        itm_labels = random.choice([0,1])
        return {
            "image": choices_img[itm_labels],
